...
# Drop iron resources when mined
# Drop iron resources when mined
func _drop_resources():
	...
	# Use rock.tscn as a base and customize it for iron
	...
	for i in range(drop_count):
		...
		# Customize the rock to be iron
		if resource.has_method("set_resource_name"):
			resource.set_resource_name("Iron")
		elif resource.has_method("set_name_for_resource"):
			resource.set_name_for_resource("Iron")
